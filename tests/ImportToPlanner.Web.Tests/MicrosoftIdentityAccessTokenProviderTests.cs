...
public sealed class MicrosoftIdentityAccessTokenProviderTests
{
        ...
        ILogger<MicrosoftIdentityAccessTokenProvider> logger)
    {
        ...
        var providerType = typeof(TenantAuthorityConfiguration).Assembly.GetType("ImportToPlanner.Web.Features.Authentication.MicrosoftIdentityAccessTokenProvider", throwOnError: true)!;
