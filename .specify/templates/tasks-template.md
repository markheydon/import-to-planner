...
### Tests for User Story 1 (MANDATORY when behaviour changes) ⚠️
...
- [ ] T013 [P] [US1] Regression test for known bug/edge case in tests/[location]/test_[name].py
...
- [ ] T020 [US1] Verify UX consistency (copy, interaction, accessibility, responsive states)
- [ ] T021 [US1] Capture performance check against defined budget
...
### Tests for User Story 2 (MANDATORY when behaviour changes) ⚠️
...
- [ ] T024 [P] [US2] Regression test for known bug/edge case in tests/[location]/test_[name].py
...
- [ ] T029 [US2] Verify UX consistency (copy, interaction, accessibility, responsive states)
- [ ] T030 [US2] Capture performance check against defined budget
...
### Tests for User Story 3 (MANDATORY when behaviour changes) ⚠️
...
- [ ] T033 [P] [US3] Regression test for known bug/edge case in tests/[location]/test_[name].py
...
- [ ] T037 [US3] Verify UX consistency (copy, interaction, accessibility, responsive states)
- [ ] T038 [US3] Capture performance check against defined budget
...
- [ ] TXXX Run quickstart.md and CI/AppHost validation
